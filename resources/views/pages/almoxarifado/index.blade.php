...
@section('main-content')
    ...
    <div class="box">
        <div class="box-header page-header">
            <h1><i class="glyphicon glyphicon-menu-right"></i>Almoxarifado</h1>
        ...
        <div class="box-body">
            <div class="row">
                ...
                {!! Form::open(['action' => ('AlmoxarifadoController@index'), 'id' => 'form', 'method' => 'GET']) !!}
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->nome }}</td>
                        <td>{{ $row->descricao }}</td>
                        <td><center>{{ $row->cidade->nome }}</center></td>
                <td>    

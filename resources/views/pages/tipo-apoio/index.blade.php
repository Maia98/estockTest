...
<div class="box">
    <div class="box-header page-header">
        <h1><i class="glyphicon glyphicon-menu-right"></i>Tipo Apoio</h1>
    ...
    <div class="box-body">
        <div class="row">
            ...
            {!! Form::open(['action' => ('TipoApoioController@index'), 'id' => 'form', 'method' => 'GET']) !!}
            <div class="col-md-4">
                <div class="input-group">
            ...
            <!-- <div class="col-md-4">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="{{ url('/sistema/tipo-apoio/exportar-excel') }}"><i class="fa fa-file-excel-o"></i> Excel</a></li>
...
@section('scripts-footer')
    <script type="text/javascript" src="{{ url('js/tabelas-tipos/tipo-apoio.js') }}"></script>
@stop
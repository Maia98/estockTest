...
<div class="box">
    <div class="box-header page-header">
        <h1><i class="glyphicon glyphicon-menu-right"></i>Tipo Status Medição</h1>
    ...
    <div class="box-body">
        <div class="row">
            ...
            {!! Form::open(['action' => ('TipoStatusMedicaoController@index'), 'id' => 'form', 'method' => 'GET']) !!}
            <div class="col-md-4">
                <div class="input-group">
            ...
            <div class="col-md-4">
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="{{url()->current().'/exportar-excel'}}"><i class="fa fa-file-excel-o"></i> Excel</a></li>
                    <li><a href="{{url()->current().'/exportar-pdf'}}" target="_blank"><i class="fa fa-file-pdf-o"></i> Pdf</a></li>
                  </ul>
                </div>
            </div>
        </div> -->
